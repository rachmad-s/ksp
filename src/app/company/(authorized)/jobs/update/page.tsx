            ...
            <div className="container mx-auto pt-1">
                <div className="flex gap-10 pb-5">
                    <div className="flex w-[800px] flex-col gap-5">
                        <input type="text" placeholder="Judul Pekerjaan" value={"Perwakilan Layanan Pelanggan"} className="focus:outline-none font-bold text-4xl" />
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {values.salaryType === 'fixed' && (
                                        <div className="flex gap-1">
                                            <Text>Rp</Text>
                                            <input type="text" placeholder="Masukan Gaji" value={10000000} className="focus:outline-none" />
                                        </div>
                                    )}
                ...
                <div className="w-[600px] flex flex-col gap-10 pb-10">
                    <div>
                        ...
                        <Skill defaultValue={['Kerja','TimKomunikasi Layanan','Masalah']}/>
                    </div>
                    <div>
                        <Title level={4}>
                            Deskripsi Pekerjaan
                        </Title>
                        <TextArea rows={5} value={`Menangani pertanyaan dan keluhan pelanggan melalui telepon, email, dan media sosial\nMemberikan informasi tentang produk dan layanan Bank Mandiri\nMembantu pelanggan dalam proses pembukaan rekening dan transaksi perbankan\nMenyusun laporan harian mengenai interaksi dengan pelanggan\nBekerja sama dengan tim untuk meningkatkan kepuasan pelanggan`} />
                    ...
                    <div>
                        ...
                        <TextArea rows={5} value={`Usia minimal 40 tahun\nPengalaman kerja di bidang layanan pelanggan minimal 3 tahun\nMemiliki latar belakang di industri perbankan (diutamakan)\nPendidikan minimal D3/S1 di bidang terkait\nKemampuan komunikasi yang baik, baik lisan maupun tulisan`}/>
                        <div className="flex gap-8 mt-4">
                            <button>
                                <BoldOutlined style={{ fontSize: '14px' }} />
                            </button>
                    ...
                    <div>
                        ...
                        <Skill defaultValue={['Asuransi Kesehatan','Kacamata']} />
                    </div>
                </div>
            </div>
